...
n_classes = 3
X_train, Y_train, X_dev, Y_dev = generate_multilabel_dataset(n_samples=15000, n_classes=n_classes, avg_labels=(n_classes - 1))
...
learning_rate = 0.001
num_epochs = 500
layers_dims = [X_train.shape[0], 4, 8, n_classes]
