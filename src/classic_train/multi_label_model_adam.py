"""
Batch Normalization Optimized Mini Batch Model using Adam optimizer
"""
...
def train_model():
    ...
    adam_mbatch_trainer = TrainerWithAdam(
        X_train=X_train,
        Y_train=Y_train,
    ...
    adam_mbatch_trainer.enable_logits()
    adam_mbatch_trainer.set_prediction_threshold(0.5)
    adam_mbatch_trainer.set_validation_data(X_dev, Y_dev)    
    adam_mbatch_trainer.set_regularization(lambda_reg)
    adam_mbatch_trainer.train()
